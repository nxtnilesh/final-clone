    ...
    <div className="flex-1 flex flex-col justify-center px-4 mt-12 mb-4">
      ...
      <div className="flex justify-center gap-3 mb-3">
        <Badge
          ...
          variant="outline"
          className="cursor-pointer bg-transparent border-gray-600 text-white hover:bg-gray-800 h-9 px-3 inline-flex items-center gap-2 text-sm w-fit"
        >
      ...
      <div className="flex justify-center gap-3 flex-wrap">
        ...
        <Badge
          ...
          variant="outline"
          className="cursor-pointer bg-transparent border-gray-600 text-white hover:bg-gray-800 h-9 px-3 inline-flex items-center justify-center text-sm w-fit"
        >
          More
        </Badge>
      </div>
